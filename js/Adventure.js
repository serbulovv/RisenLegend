...
function showDungeonMenu() {
    ...
    for (var key in retrievedObject.dungeons_info) {
        if (retrievedObject.dungeons_info[key].unlocked == false) {
            resDungeonList += '<div class="col-4 mx-auto block_menu mb-3"><div class="image_div border border-5 border-dark" onclick = "show_units_page([' + retrievedObject.dungeons_info[key].units_ID + '])"><img class="w-100 h-100" src="/assets/background_images/locked.png"></div><span class="fs-5 text-light">' +
